...
#### STOPPED HERE APRIL 24 #### 

rast_cell_id    <- raster(cell_id_file)
rast_ocean_500m  <- raster(ocean_500m_file)
#plot(rast_ocean_500m) #check to see if loaded properly 

wdpa_marine_file <- file.path(dir_raw_data_anx, 'wdpa_mpa/d2020/wdpa_mar_by_cat_Apr2020_500m.tif')
wdpa_poly_file   <- file.path(dir_raw_data_anx, 'wdpa_mpa/d2020/WDPA_Apr2020-shapefile', 
                              'WDPA_Apr2020-shapefile-polygons.shp')
...
if(!file.exists(wdpa_marine_file)) {
  ...
  #ocean_500m_extent <- rast_ocean_500m@extent
  
  #wdpa_marine_buffer <- sf::st_buffer(wdpa_marine, dist = 0)
  #wdpa_marine_crop <- sf::st_crop(wdpa_marine, y = c(xmin = -14192430, ymin = -8953182, xmax = 14192570, ymax = 8984818))
...
wdpa_prot_yr_file <- file.path(dir_raw_data_anx, 'wdpa_mpa/d2019', 
                               'wdpa_mar_by_prot_yr_Apr2019_500m.tif')
