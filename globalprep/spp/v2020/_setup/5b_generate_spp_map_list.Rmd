...
dir_bli <- file.path(dir_M, 'git-annex/globalprep/_raw_data/birdlife_intl/d2020')
...
bli_marine_shp <- file.path(dir_bli, 'bli_marine_v2019.shp')
...
### Dermochelys coriacea Southeast Atlantic is 6494
