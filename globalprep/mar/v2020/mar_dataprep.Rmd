...
mar_sp <- read.csv('raw/species_list.csv', stringsAsFactors=FALSE) %>%
  select(FAO_name, exclude, alias, Taxon_code, family)
...
## 5666 of these out of 28149+5662 cases had NA values converted to 0 - 2020 assessment
...
gf_sw_sp_w <- sw_sus_rgn %>% 
  ...
  add_row(rgn_id = 82, rgn_name = 'Albania', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>% 
  add_row(rgn_id = 84, rgn_name = 'Algeria', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 232, rgn_name = 'Bosnia and Herzegovina', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 187, rgn_name = 'Croatia', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 81, rgn_name = 'Cyprus', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 214, rgn_name = 'Egypt', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 179, rgn_name = 'France', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 80, rgn_name = 'Greece', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 79, rgn_name = 'Israel', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 184, rgn_name = 'Italy', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 78, rgn_name = 'Lebanon', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 67, rgn_name = 'Libya', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 68, rgn_name = 'Malta', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 185, rgn_name = 'Monaco', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 186, rgn_name = 'Montenegro', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 62, rgn_name = 'Morocco', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 188, rgn_name = 'Slovenia', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 182, rgn_name = 'Spain', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 77, rgn_name = 'Syria', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 61, rgn_name = 'Tunisia', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>%
  add_row(rgn_id = 76, rgn_name = 'Turkey', species = 'Atlantic bluefin tuna', score = 4.42, match_type = 'sw_sp_w',   .after = 1) %>% 

  # Gilthead seabream - Marine net pen
  add_row(rgn_id = 82, rgn_name = 'Albania', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>% 
  add_row(rgn_id = 84, rgn_name = 'Algeria', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 232, rgn_name = 'Bosnia and Herzegovina', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 187, rgn_name = 'Croatia', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 81, rgn_name = 'Cyprus', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 214, rgn_name = 'Egypt', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 179, rgn_name = 'France', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 80, rgn_name = 'Greece', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 79, rgn_name = 'Israel', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 184, rgn_name = 'Italy', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 78, rgn_name = 'Lebanon', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 67, rgn_name = 'Libya', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 68, rgn_name = 'Malta', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 185, rgn_name = 'Monaco', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 186, rgn_name = 'Montenegro', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 62, rgn_name = 'Morocco', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 188, rgn_name = 'Slovenia', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 182, rgn_name = 'Spain', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 77, rgn_name = 'Syria', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 61, rgn_name = 'Tunisia', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>%
  add_row(rgn_id = 76, rgn_name = 'Turkey', species = 'Gilthead seabream', score = 4.42, match_type = 'sw_sp_w',   .after = 23) %>% 
  
  # Meagre - Marine net pen
  add_row(rgn_id = 82, rgn_name = 'Albania', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>% 
  add_row(rgn_id = 84, rgn_name = 'Algeria', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 232, rgn_name = 'Bosnia and Herzegovina', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 187, rgn_name = 'Croatia', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 81, rgn_name = 'Cyprus', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 214, rgn_name = 'Egypt', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 179, rgn_name = 'France', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 80, rgn_name = 'Greece', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 79, rgn_name = 'Israel', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 184, rgn_name = 'Italy', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 78, rgn_name = 'Lebanon', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 67, rgn_name = 'Libya', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 68, rgn_name = 'Malta', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 185, rgn_name = 'Monaco', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 186, rgn_name = 'Montenegro', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 62, rgn_name = 'Morocco', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 188, rgn_name = 'Slovenia', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 182, rgn_name = 'Spain', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 77, rgn_name = 'Syria', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 61, rgn_name = 'Tunisia', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>%
  add_row(rgn_id = 76, rgn_name = 'Turkey', species = 'Meagre', score = 4.29, match_type = 'sw_sp_w',   .after = 45) %>% 
  
# European seabass - Marine net pen
  add_row(rgn_id = 82, rgn_name = 'Albania', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>% 
  add_row(rgn_id = 84, rgn_name = 'Algeria', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 232, rgn_name = 'Bosnia and Herzegovina', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 187, rgn_name = 'Croatia', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 81, rgn_name = 'Cyprus', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 214, rgn_name = 'Egypt', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 179, rgn_name = 'France', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 80, rgn_name = 'Greece', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 79, rgn_name = 'Israel', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 184, rgn_name = 'Italy', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 78, rgn_name = 'Lebanon', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 67, rgn_name = 'Libya', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 68, rgn_name = 'Malta', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 185, rgn_name = 'Monaco', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 186, rgn_name = 'Montenegro', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 62, rgn_name = 'Morocco', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 188, rgn_name = 'Slovenia', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 182, rgn_name = 'Spain', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 77, rgn_name = 'Syria', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 61, rgn_name = 'Tunisia', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67) %>%
  add_row(rgn_id = 76, rgn_name = 'Turkey', species = 'European seabass', score = 4.45, match_type = 'sw_sp_w',   .after = 67)
...
# test_dups <- mar_sw_sus %>%
#   duplicated() 
# 
# tests_3 <- data.frame(test_dups, mar_sw_sus) %>%
#   filter(test_dups == TRUE)
# 
# test4 <- mar_sw_sus %>%
#   filter(species == "Pacific cupped oyster")
...
# esc_score still have 17348 NAs out of 28742 total obs; ~60% without scores
...
mar_sw_sus_final = mar_sw_sus_test %>%
