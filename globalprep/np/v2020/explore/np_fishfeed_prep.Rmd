...
foragefish_list <- read_csv("output/master_taxa_list.csv")
...
# sum(catch_fishfeed$tons, na.rm = TRUE)
# sum(catch$tons, na.rm = TRUE)
# 
# 1932000985/4589496167
```

# Step 3

## Join with the final B/Bmsy layer from the fis model 
