...
watson_new_corr <- read_csv(file.path(here(), "globalprep/np/v2020/explore/int/watson_new_corr.csv"))
...
write.csv(foragefish_list, here("globalprep/np/v2020/explore/int/master_taxa_list_v5.csv"), row.names=FALSE)
...
foragefish_list <- read_csv(file.path("globalprep/np/v2020/explore/int/master_taxa_list.csv"))
...
```{r}
catch_fishfeed <- read_csv(file.path(here(),"globalprep/np/v2020/explore/int/watson_catch_forage_fish.csv"))
...
catch_FOFM <- read_csv(file.path(here(), "globalprep/np/v2020/explore/int/mean_catch_FOFM.csv")) 
...
####
 ...
 penaltyTable <- data.frame(TaxonPenaltyCode = 1:6,
  ...
  write.csv(gap_fill_data, here('globalprep/np/v2020/explore/int/NP_bbmsy_summary_gf.csv'), row.names = FALSE)
...
write.csv(score_data, here('globalprep/np/v2020/explore/output/np_fofm_scores.csv'), row.names = FALSE)
