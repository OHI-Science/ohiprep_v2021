...
Instead of using all NP commodity categories (seaweed, FOFM, coral, sponge, and ornamentals), we are only prepping seaweeds in this data prep. Overall, we are excluding corals and sponges from our calculations for the NP goal. FOFM and seaweed production are calculated from FAO mariculture datasets, while ornamentals production is calculated from FAO commodities datasets. New year of FAO mariculture data (1950-2018). 
...
write.csv(seaweed_tonnes, 'int/np_seaweed_tonnes_weighting.csv', row.names = FALSE, na = '')
