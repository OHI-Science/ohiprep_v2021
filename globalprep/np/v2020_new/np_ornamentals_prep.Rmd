...
write.csv(tonnes_ornamentals_rel, 'int/np_ornamentals_scores_no_sust.csv', row.names = FALSE, na = '')


```

## Incorporate sustainability layer for ornamentals scores using cyanide/blast layers
