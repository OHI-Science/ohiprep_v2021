...
[Vasquez and Vega 2001](https://www.researchgate.net/publication/226813687_Chondracanthus_chamissoi_Rhodophyta_Gigartinales_in_northern_Chile_Ecological_aspects_for_management_of_wild_populations) is a study in Chile that indicate that *Chondracanthus chamissoi* is used as both food and carageenan. This [Wikipedia page](https://es.wikipedia.org/wiki/Chondracanthus_chamissoi) indicates that *C. chamissoi* is highly consumed in Peru, whereas in Chile, this species is primarily a carageenan-producing product [(Bulboa et al 2005)](https://onlinelibrary.wiley.com/doi/full/10.1111/j.1365-2109.2005.01321.x). While the primary use of this species is not so clear-cut, we have one more paper that identifies *C. chamissoi* as a human food product [(Fig 1. in Buschmann et al 2017)](https://www.tandfonline.com/doi/full/10.1080/09670262.2017.1365175), so we chose to include it.
...
Production by weight is overwhelmingly from China (see plot below). Given that over 80% of seaweed produced in aquaculture systems are used for human consumption, we chose to include this generalized FAO species category in goal calculations.
...
Green seaweeds are mostly used for non-food products. While some seaweed is used as food it is still underutilized or growing slowly in Portugal [(Soares et al 2017)](http://iopscience.iop.org/article/10.1088/1757-899X/231/1/012126/pdf).
