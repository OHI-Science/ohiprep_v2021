...
## Save in 'globalprep/np/v2020_new/raw' as 'species_list_np_seaweeds.csv'. Export and edit csv file directly to go through each species and confirm if appropriate to include in NP goal, adding to 'notes_2' column why each species is included/excluded and what proportion (with a reference).
...
mar_sus_final = mar_sus_gf %>% 
  ...
  select(rgn_id, species, species_code, taxa_code, taxa_group=Taxon_code, year, gapfill_sus = gapfill, gapfill_fao = gap_0_fill, tonnes, sust_coeff = Sust)
...
EVERYTHING BELOW HERE WILL BE MOVED TO FUNCTIONS.R
