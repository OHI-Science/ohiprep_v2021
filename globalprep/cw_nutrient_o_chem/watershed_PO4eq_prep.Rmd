...
```{r}
fils <- list.files("/home/jkibele/wastewater/code/plumes/output/pour_points_1", pattern="tif$", full.names = FALSE, recursive = TRUE)
...
files <- data_frame(fils) ## 24499

fils <- list.files("/home/jkibele/wastewater/code/plumes/output/pour_points_2", pattern="tif$", full.names = FALSE, recursive = TRUE)
...
files <- data_frame(fils) ## 22929

fils <- list.files("/home/jkibele/wastewater/code/plumes/output/pour_points_3", pattern="tif$", full.names = FALSE, recursive = TRUE)
...
files <- data_frame(fils) ## 24618

fils <- list.files("/home/jkibele/wastewater/code/plumes/output/pour_points_4", pattern="tif$", full.names = FALSE, recursive = TRUE)
...
files <- data_frame(fils) ## 21821 

21821 + 24618 + 22929 + 24499 ## 93867 


test_rast <- raster::raster(file.path("/home/jkibele/wastewater/code/plumes/output/pour_points_4/plume_effluent_af_01069.tif"))

mapview(test_rast)
```

Look at mosaiced PO4eq tif files
```{r}
PO4eq_sub1 <- raster::raster(file.path("/home/sgclawson/wastewater-master/code/plumes/output/subsets/global_effluent_PO4eq_sub1.tif"))

mapview(PO4eq_sub1)
plot(log(PO4eq_sub1+1))

PO4eq_sub2 <- raster::raster(file.path("/home/sgclawson/wastewater-master/code/plumes/output/subsets/global_effluent_PO4eq_sub2.tif"))

mapview(PO4eq_sub2)
plot(log(PO4eq_sub2+1))
```
