---
title: 'OHI 2020 - Sea Level Rise Pressure Layer'
...
scen_year <- 2020 # change to reflect assessment year!
...
# didn't download new data for v2020 since data has only been updated until September 2019, and we need up until Dec 2019. Therefore, we're using v2019 (data up to Dec 2018)
...
year <- 2019 # data year to download
...
for (mo in months){ 
  ...
  u_filename <- file.path(dir_anx_aviso, "d2020", substr(u, 115, 155)) #updated 2020 to include full filename
...
plot(raster(nc_files[3]), col = cols, axes = F, 
     main = paste("Year", substr(nc_files[3], 90, 93), "Month", substr(nc_files[3], 96, 97))) # didn't work
