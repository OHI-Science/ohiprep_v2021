...
data_yr_gpw <- "d2019" # change to reflect year of most recently downloaded data! (no change for v2020)
data_yr_un_pop <- "d2020" # change to reflect year of most recently downloaded data!

## Sefine commonly used file paths (matched to what we did in ico_data_prep.Rmd)
